...
import com.vambeco.stockmanager.facade.JobtitleFacade;
...
public class JobtitleController implements Serializable {
    ...
    @EJB
    private com.vambeco.stockmanager.facade.JobtitleFacade ejbFacade;
    ...
    public static class JobtitleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Jobtitle) {
                ...
                return getStringKey(o.getJobtitleId());
            } else {
